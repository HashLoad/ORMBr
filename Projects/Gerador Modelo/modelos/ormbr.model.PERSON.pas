...
type
  ...
  private
    ...
    FPERSON_FLD4: Nullable<ftBlob>;
    FPERSON_FLD5: Nullable<Double>;
    FPERSON_FLD6: Nullable<TDateTime>;
    FPERSON_FLD7: Nullable<TTime>;
    FPERSON_FLD8: Nullable<TDateTime>;
    FPERSON_FLD9: Nullable<String>;
    FPERSON_FLD10: Nullable<String>;
    FPERSON_FLD11: Nullable<ftBlob>;
    FPERSON_FLD12: Nullable<ftBlob>;
    FPERSON_FLD13: Nullable<ftBlob>;
  public 
    { Public declarations } 
    ...
    [Column('PERSON_FLD4', ftBlob)]
    [Dictionary('PERSON_FLD4', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PERSON_FLD4: Nullable<ftBlob> read FPERSON_FLD4 write FPERSON_FLD4;
    ...
    [Column('PERSON_FLD6', ftDateTime)]
    [Dictionary('PERSON_FLD6', 'Mensagem de validação', '', '', '', taCenter)]
    property PERSON_FLD6: Nullable<TDateTime> read FPERSON_FLD6 write FPERSON_FLD6;
    ...
    property PERSON_FLD11: Nullable<ftBlob> read FPERSON_FLD11 write FPERSON_FLD11;

    [Column('PERSON_FLD12', ftBlob)]
    [Dictionary('PERSON_FLD12', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PERSON_FLD12: Nullable<ftBlob> read FPERSON_FLD12 write FPERSON_FLD12;

    [Column('PERSON_FLD13', ftBlob)]
    [Dictionary('PERSON_FLD13', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PERSON_FLD13: Nullable<ftBlob> read FPERSON_FLD13 write FPERSON_FLD13;
  end;

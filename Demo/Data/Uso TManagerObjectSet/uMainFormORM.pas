...
begin
  ...
  LMasterUpd := FManager.NestedList<Tmaster>.Items[StringGridMaster.Row-1];
...
//  FManager.Current<Tmaster>.client_name := edtClient_Nome.Text;
  // Child
...
//  FManager.Current<Tmaster>.detail.Last.master_id := -1;
  ...
  FManager.Insert<Tmaster>(FManager.Current<Tmaster>);
